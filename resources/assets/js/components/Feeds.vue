      ...
      <div class="col-md-3 col-sm-4 article-cell my-card" v-for="post in posts">
          ...
          {{post.post_text}}
             ...
             <footer class="w3-container">
                            ...
                            <router-link :to="{name:'single_post'}">
                   <a href="" class="w3-btn-floating w3-teal w3-white w3-border w3-border-teal w3-medium"><i class="fa fa-comments" aria-hidden="true"></i>
                   </a>
                          </router-link>
